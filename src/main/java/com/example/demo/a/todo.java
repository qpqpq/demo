...
//
//            1.2. "Customer" or "You" means a student or an instructor specified in the Subscription Confirmation who is at least 13 years old, or in the case of Redistributable Products the sole proprietor or legal entity with sufficient legal capacity to enter into this Agreement using the Redistributable Product in accordance with this Agreement. For the purpose of this Agreement, a student is an individual who is enrolled at a recognized educational institution (university, college, high school, primary school or a similar institution with educational goals), and upon request by JetBrains is able to provide proof of such enrollment. For the purpose of this Agreement, an instructor is an individual who gives lectures and/or seminars at a recognized educational institution (university, college, high school, primary school or a similar institution with educational goals), and upon request by JetBrains is able to provide proof of such involvement.
//
//            2. DEFINITIONS
//
...
//
//            10.4. JetBrains will make reasonable effort to notify Customer via an email as follows:
//
