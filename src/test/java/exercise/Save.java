...
/**
 * @author pangkun
 * @date 2019/5/8 上午9:25
 */
public class Save {
    public static void main(String[] args) throws IOException, JSONException {
        URLConnection urlConnection = new URL("http://127.0.0.1:8080/exercise/save").openConnection();
        ...
        jsonObject.put("strength","22" );
        jsonObject.put("ctime","23" );
